            ...
            if (list) {
                ...
                li.innerHTML = `
                    ...
                    <button class="cart-btn" data-id="${product.id}">
                        <i class="fas ${product.category === 'Coffee' || product.category === 'Snack' ? 'fa-cart-plus' : 'fa-calendar-check'}"></i> 
                        ${isAvail ? (product.category === 'Coffee' || product.category === 'Snack' ? 'Add to Cart' : 'Book Now') : 'Not Available'}
                    </button>
                `;
                list.appendChild(li);
...
function initCartButtons() {
    document.querySelectorAll('.cart-btn').forEach(button => {
        ...
        button.addEventListener('click', () => {
            ...
            // If it's a booking-type item, redirect to book.html with the product name
            if (category === 'study-category' || category === 'wifi-category' || category === 'printing-category' || category === 'amenities-category' || category === 'lounge-category') {
