...
const AppInitializer = {
    ...
    loadSampleData() {
        ...
        // Add a sample item to the cart state for initial testing
        cart.push({
            id: nextItemId++,
            name: "Espresso",
            price: 2.50,
        ...
        // Initial render of the cart is handled by CartSystem.init()
    },

    /**
     * The main application initialization method.
     */
    init() {
        // 1. Theme and Dropdowns
        this.setupTheme();
        this.setupDropdowns();
        
        // 2. Systems Initialization
        // Assuming SearchSystem, BioManager, LocationManager are defined elsewhere
        SearchSystem.init(); 
        BioManager.init();
        LocationManager.init();
        CartSystem.init(); // 👈 Initialize the cart system
        
        // 3. Messages/Notifications setup
